...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial = 1.0           # initiate trial counting for Q-learning
...
#           self.epsilon = 1 / pow(self.trial, 2) 
    ...
    def choose_action(self, state):
        ...
        #   Otherwise, choose an action with the highest Q-value for the current state
                ...
                state_tmp = self.Q[state]                
                maxQ = self.get_maxQ(state)
                best_action_tmp = [k for k, v in state_tmp.iteritems() if v == maxQ]
                action = random.choice(best_action_tmp)
                print 'action', action
