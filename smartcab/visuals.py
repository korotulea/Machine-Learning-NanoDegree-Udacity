...
def plot_trials(csv):
	...
	print 'Total Bad Actions mean is {:.2f}%'.format(np.mean((1 - actions['good']))*100)
	print 'Total Minor Violation mean is {:.2f}%'.format(np.mean(actions['minor'])*100)
 	print 'Total Major Violation mean is {:.2f}%'.format(np.mean(actions['major'])*100)
	print 'Total Minor Accident mean is {:.2f}%'.format(np.mean(actions['minor_acc'])*100)
 	print 'Total Major Accident mean is {:.2f}%'.format(np.mean(actions['major_acc'])*100)
